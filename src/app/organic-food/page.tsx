                ...
                <Card key={index} className="group overflow-hidden border-0 transition-all duration-500 hover:scale-105 h-full flex flex-col rounded-3xl">
                  <div className="relative h-64 overflow-hidden rounded-t-3xl">
                    ...
                    <div className="absolute top-4 left-4">
                      <Badge className="bg-gradient-to-r from-green-600 to-emerald-600 text-white border-0 shadow-lg backdrop-blur-sm">
                        <Leaf className="w-3 h-3 mr-1 drop-shadow-sm" />
                        Organic
                      </Badge>
                    </div>
                    <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  </div>
                  <CardContent className="p-6 flex flex-col flex-grow rounded-b-3xl bg-black/20 backdrop-blur-sm transition-all duration-300">
                    <div className="flex items-start justify-between mb-3">
                      <h3 className="text-xl font-bold text-white group-hover:text-green-300 transition-colors duration-300 flex-1 pr-2 drop-shadow-lg">
                        {item.name}
                      </h3>
                    ...
                    <p className="text-white leading-relaxed text-sm flex-grow font-medium drop-shadow-lg">
                      {item.description}
                    </p>
                  </CardContent>
                </Card>
